...
gogo_gadget_arms("dplyr")
```
  All those gogo_s now live in your search path in an environment called `gadget`
  ...
  useful package also called `gadget`. In that case, sorry, together we probably busted 
